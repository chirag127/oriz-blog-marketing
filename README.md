# Marketing — `oriz-blog-marketing`

> Attention, earned — growth, content, and the marketing that compounds.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-marketing?style=flat)](https://github.com/chirag127/oriz-blog-marketing/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-marketing)](https://github.com/chirag127/oriz-blog-marketing/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-marketing/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-marketing/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Marketing** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
A marketing blog on growth, content, SEO, and brand — tactics grounded in what compounds rather than what trends.

- **Live site:** https://marketing-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-marketing
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-marketing/ — the canonical, always-current site is **https://marketing-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-marketing/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>marketing-blog.oriz.in"]
...
oriz-blog-marketing/
├── src/
│   ├── content/blog/       # the marketing playbooks (MDX/Markdown)
